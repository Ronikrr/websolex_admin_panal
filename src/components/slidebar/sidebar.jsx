...
//                         // { id: 11, icon: <FaUser />, label: "users chats", link: "/websolex/userchat" },
//                     ],
//                 },
//                 {
...
//             <div className={` flex-col hidden overflow-hidden md:flex md:w-[289.9px] main_class h-screen  text-white bg-[#1C2434] transition-all duration-500 ease-in-out `}>
