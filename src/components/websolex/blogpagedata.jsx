...
//                 `${API}/api/blogpage/${selectedLead._id}`,
//                 formDataToSend,
//                 {
//                     headers: { "Content-Type": "multipart/form-data" },
//                 },
...
//         // Validate form
//         const validationErrors = validateBlogForm({ name: { name }, formData })
...
//                     type: "success",
//                 })
//                 // Update the leads state with the new blog post
//                 setLeads((prevLeads) => [...prevLeads, response.data.blogadd.savedblogadd])
//                 resetFormFields(e)
//             }
//         } catch (error) {
...
//         // Validate form
//         if (!validateBlogForm({ name: { name }, formData })) return
